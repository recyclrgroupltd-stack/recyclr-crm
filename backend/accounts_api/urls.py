...
urlpatterns = [
    ...
    path("admin/reset-crm-data/", reset_crm_data_view, name="api-reset-crm-data"),
    ...
    path("staff/<int:user_id>/password/", reset_staff_password_view, name="api-staff-password-reset"),
    path("staff/<int:user_id>/delete/", delete_staff_user_view, name="api-staff-delete"),
    path(
